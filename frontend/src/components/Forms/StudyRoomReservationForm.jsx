      ...
      <form onSubmit={handleFormSubmit} className="border p-4 rounded">
        ...
        <div className="mb-3">
          <input
            ...
            disabled={bookedTimes.some(
              (timeSlot) =>
                timeSlot.startTime === "8" && timeSlot.endTime === "10"
            )}
          />{" "}
        ...
        <div className="mb-3">
          <input
            ...
            disabled={bookedTimes.some(
              (timeSlot) =>
                timeSlot.startTime === "10" && timeSlot.endTime === "12"
            )}
          />{" "}
        ...
        <div className="mb-3">
          <input
            ...
            disabled={bookedTimes.some(
              (timeSlot) =>
                timeSlot.startTime === "12" && timeSlot.endTime === "14"
            )}
          />{" "}
        ...
        <div className="mb-3">
          <input
            ...
            disabled={bookedTimes.some(
              (timeSlot) =>
                timeSlot.startTime === "14" && timeSlot.endTime === "16"
            )}
          />{" "}
