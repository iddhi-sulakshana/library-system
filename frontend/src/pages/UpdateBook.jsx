...
const UpdateBook = () => {
  ...
  const getSingleBooks = async () => {
    try {
      const response = await axios.get(window.host + "/api/books/" + slug);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(window.host + "/api/books/" + slug, formData);
                      ...
                      <div className='space-y-1 text-center'>
                        {!selectedFile ? (
                          <>
                            <img
                              src={
                                window.host + "/bookCovers/" + book.imagePath
                              }
                    ...
                    <div className='flex max-w-lg'>
                      <div className='mt-4 space-y-4'>
                        ...
                        >
                          <option
                            value='fiction'
                            selected={book.category === "fiction"}
                          >
                            Fiction
                          </option>
                          <option
                            value='non-fiction'
                            selected={book.category === "non-fiction"}
                          >
                            Non-Fiction
                          </option>
                          <option
                            value='poetry'
                            selected={book.category === "poetry"}
                          >
                            Poetry
                          </option>
                          <option
                            value='drama/play'
                            selected={book.category === "drama/play"}
                          >
                            Drama / Play
                          </option>
                          <option
                            value='other'
                            selected={book.category === "other"}
                          >
                            Other
                          </option>
                        </select>
