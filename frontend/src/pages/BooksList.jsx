                  ...
                  <tbody className='divide-y divide-gray-200 bg-white'>
                    {books.map((book) => (
                      <tr key={book.bookId}>
                        ...
                        <td className='whitespace-nowrap px-3 py-4 text-sm text-gray-500'>
                          {book.availability ? (
                            <span className='font-normal text-black bg-green-400 px-2 py-1 rounded-lg capitalize'>
                              Available
                            </span>
                          ) : (
                            <span className='font-normal text-black bg-red-400 px-2 py-1 rounded-lg capitalize'>
                              Not-Available
                            </span>
                          )}
                        </td>
